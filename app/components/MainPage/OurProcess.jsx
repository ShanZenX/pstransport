...
const OurProcess = () => {
  return (
    <section className="bg-white py-15 sm-5 lg:m-15 ">
      <div className="text-center mb-10">
        <h2 className=" text-2xl md:text-[32px] !font-extrabold mb-4 flex justify-center items-center gap-2 sm:mb-6  ">
          <span className="h-[4px] w-[20px] bg-gray-800 block"></span> What we <span className="text-red-700">
            Offer
          </span>
        ...
        {services.map((service, index) => (
          ...
          >
            <Image
              src={service.image}
              alt={service.title}
              className="w-full h-[54px] lg:h-[85px] object-cover transition-transform duration-300 group-hover:scale-105"
            />
