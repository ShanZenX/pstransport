      ...
      >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2  gap-2 mb-4">
            {[
              ...
              <div key={idx} className="flex  items-center gap-2 text-lg">
                <FaCheckCircle className="text-red-700  text-sm" />
          ...
          <div className="flex  items-center gap-3">
            <button className="bg-red-700 flex items-center gap-3 hover:bg-red-900 text-white px-4 py-2 rounded-md shadow-sm font-medium text-sm transition">
              <FaPhoneAlt size={16} />
              Request a Quote
            </button>
          </div>
